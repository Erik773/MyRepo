...
Процедура КомандаСогласование(Команда)
	КомандаСогласованиеНаСервере();
КонецПроцедуры

&НаСервере
Процедура КомандаСогласованиеНаСервере()
	БизнесПроцессОбъект = ЭтаФорма.Объект.БизнесПроцесс.ПолучитьОбъект();
	
	Если БизнесПроцессОбъект.СогласованиеЗаказа = ЛОЖЬ Тогда 
		БизнесПроцессОбъект.СогласованиеЗаказа = ИСТИНА;
	Иначе
		БизнесПроцессОбъект.СогласованиеЗаказа = ЛОЖЬ;
	КонецЕсли;
	
	БизнесПроцессОбъект.Записать();	
	УстановитьСтатусСогласования();
...
&НаСервере
Процедура УстановитьСтатусСогласования()
	ЭтаФорма.Согласование = РеквизитФормыВЗначение("Объект").БизнесПроцесс.ПолучитьОбъект().СогласованиеЗаказа;
КонецПроцедуры
