...
Процедура ОбработкаЗаказаПриСозданииЗадач(ТочкаМаршрута, ФормируемыеЗадачи, Отказ)
	Для Каждого Задача Из ФормируемыеЗадачи Цикл
		...
		ЗадатьУникальноеНазвание(Задача);
		Записать();
	КонецЦикла;
КонецПроцедуры
...
Процедура ЗадатьУникальноеНазвание(Задача)
	СвязанныйЗаказ = Справочники.Заказы.НайтиПоРеквизиту("БизнесПроцесс", ЭтотОбъект.Ссылка);
	Задача.Наименование = Задача.Наименование + " " + СвязанныйЗаказ.Название;
КонецПроцедуры
