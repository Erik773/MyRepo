...
Функция ТекстЗапросаСпискаСЗащитойПерсональныхДанных()
	Возврат "ВЫБРАТЬ
	|	Справочник_ДемоФизическиеЛица.Ссылка КАК Ссылка,
	|	Справочник_ДемоФизическиеЛица.ПометкаУдаления КАК ПометкаУдаления,
	|	Справочник_ДемоФизическиеЛица.Родитель КАК Родитель,
	|	Справочник_ДемоФизическиеЛица.ЭтоГруппа КАК ЭтоГруппа,
	|	Справочник_ДемоФизическиеЛица.Наименование КАК Наименование,
	|	Справочник_ДемоФизическиеЛица.ДатаРождения КАК ДатаРождения,
	|	Справочник_ДемоФизическиеЛица.Пол КАК Пол,
	|	Справочник_ДемоФизическиеЛица.МестоРождения КАК МестоРождения,
	|	Справочник_ДемоФизическиеЛица.Гражданство КАК Гражданство,
	|	Справочник_ДемоФизическиеЛица.СерияДокумента КАК СерияДокумента,
	|	Справочник_ДемоФизическиеЛица.НомерДокумента КАК НомерДокумента,
	|	Справочник_ДемоФизическиеЛица.КемВыданДокумент КАК КемВыданДокумент,
	|	Справочник_ДемоФизическиеЛица.КодПодразделенияДокумента КАК КодПодразделенияДокумента,
	|	Справочник_ДемоФизическиеЛица.ДатаВыдачиДокумента КАК ДатаВыдачиДокумента,
	|	Справочник_ДемоФизическиеЛица.СНИЛС КАК СНИЛС,
	...
	|	КОНЕЦ КАК ПДнСкрыты
	|ИЗ
	|	Справочник._ДемоФизическиеЛица КАК Справочник_ДемоФизическиеЛица
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СубъектыДляСкрытияПерсональныхДанных КАК СубъектыСоКрытымиПДн
	|		ПО Справочник_ДемоФизическиеЛица.Ссылка = СубъектыСоКрытымиПДн.Субъект
