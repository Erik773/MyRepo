...
Процедура ОформляемыеПоляПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ИзменитьОформляемоеПоле(Неопределено, Отказ);
...
Процедура ОформляемыеПоляПередНачаломИзменения(Элемент, Отказ)
	...
	Если Строка <> Неопределено Тогда 
		ТекущееПоле = НайденноеПолеОформления(КомпоновщикНастроек.Настройки, Строка.Поле);
	КонецЕсли;
	
	ИзменитьОформляемоеПоле(ТекущееПоле, Отказ);
...
&НаКлиенте
Процедура ИзменитьОформляемоеПоле(ТекущееПоле, Отказ)
	...
	ПараметрыВыбора.Вставить("НастройкиОтчета", НастройкиОтчета);
	ПараметрыВыбора.Вставить("КомпоновщикНастроек", КомпоновщикНастроек);
	ПараметрыВыбора.Вставить("Режим", "УсловноеОформление");
	ПараметрыВыбора.Вставить("ПолеКД", ?(ТекущееПоле = Неопределено, Неопределено, ТекущееПоле.Поле));
	ПараметрыВыбора.Вставить("ИдентификаторЭлементаСтруктурыНастроек",  ИдентификаторЭлементаСтруктурыНастроек);
	
	Обработчик = Новый ОписаниеОповещения("ПослеВыбораОформляемогоПоля", ЭтотОбъект, ТекущееПоле);
...
&НаКлиенте
Процедура ПослеВыбораОформляемогоПоля(ВыбранноеЗначение, ТекущееПоле) Экспорт 
	...
	Оформление = Оформление(ЭтотОбъект);
	ДоступныеПоля = Оформление.ДоступныеПоляПолей;
	...
	Если ТекущееПоле = Неопределено Тогда 
		...
		ПолеОформления = НайденноеПолеОформления(КомпоновщикНастроек.Настройки, ВыбранноеЗначение.Поле);
	...
	ПолеОформления.Поле = ВыбранноеЗначение.Поле;
	ПолеОформления.Использование = Истина;
