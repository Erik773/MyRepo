...
Функция ИмяОбработкиТранспортаСообщенийОбмена(ВидТранспорта)
	...
	Если ВидТранспорта = Перечисления.ВидыТранспортаСообщенийОбмена.EMAIL Тогда
		Возврат Метаданные.Обработки.ТранспортСообщенийОбменаEMAIL.Имя;
	ИначеЕсли ВидТранспорта = Перечисления.ВидыТранспортаСообщенийОбмена.FILE Тогда
		Возврат Метаданные.Обработки.ТранспортСообщенийОбменаFILE.Имя;
	ИначеЕсли ВидТранспорта = Перечисления.ВидыТранспортаСообщенийОбмена.FTP Тогда
		Возврат Метаданные.Обработки.ТранспортСообщенийОбменаFTP.Имя; 
	ИначеЕсли ВидТранспорта = Перечисления.ВидыТранспортаСообщенийОбмена.ВнешняяСистема
		И ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ОбменДаннымиСВнешнимиСистемами") Тогда
		Возврат "ТранспортСообщенийОбменаВнешняяСистема";
	Иначе
		Возврат "";
	КонецЕсли;
...
// Возвращаемое значение:
//  Структура - см функцию СтруктураНастроекОбменаБазовая
...
//	  * ВидТранспортаОбмена - ПеречислениеСсылка.Перечисления.ВидыТранспортаСообщенийОбмена - вид транспорта,
...
//	  * Отказ - Булево.
//	  * ЭтоОбменВРИБ - Булево.
//	  * ОбработкаОбменаДанными - ОбработкаМенеджер.
...
//	  * ДополнительныеПараметры - Струкутра.
